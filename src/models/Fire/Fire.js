...
import NZW from './textures/nzw.png';
import FIRETEX from './textures/firetex.png';
...
const Fire = (function() {
    ...
    var Fire = function(width, height, depth, sliceSpacing, camera) {
        this.camera = camera;
    ...
    Fire.prototype.update = function(elapsed) {
    ...
    Fire.prototype.updateGeometry = function() {
    ...
    Fire.prototype.updateViewVector = function() {
        // TODO
